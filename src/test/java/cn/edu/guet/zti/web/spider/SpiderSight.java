...
import cn.edu.guet.zti.web.spider.ajax.commentFormData;
import cn.edu.guet.zti.web.spider.ajax.commentRequestPayload;
import cn.edu.guet.zti.web.spider.downloader.CustomHttpClientDownloader;
import cn.edu.guet.zti.web.spider.pipeline.ConsolePipeline;
import cn.edu.guet.zti.web.spider.pipeline.SightPipeline;
import cn.edu.guet.zti.web.spider.pipeline.persistent.PersistentPlacePipeline;
import cn.edu.guet.zti.web.spider.pipeline.persistent.PersistentSightPipeline;
import cn.edu.guet.zti.web.spider.processor.SightPageProcessor;
import cn.edu.guet.zti.web.spider.processor.ToSightPageProcessor;
...
//                .run();
    ...
    public void crawlASightAndPersistent() {
        int beginLine = 1;
        String filePath = "景点第五次爬取.txt";
//        String filePath = "景点评论第一次爬取.txt";
...
//        int beginLine = 7459;
//        String filePath = "景点第二次爬取.txt";
        int beginLine = 1;
        String filePath = "景点第三次爬取.txt";
    ...
    public void resolveLogsAndaddSight() {
        ...
        int beginLine = 1;
        String filePath1 = "景点第一次爬取.txt";
        String filePath2 = "景点第二次爬取.txt";
